	...
	(function($) {
		...
		$.fn.html5lightbox = function(options) {
			...
			inst.options = jQuery.extend({
				...
				// title
				titlecss:				"{color:#999; font-size:14px; font-family:Armata,sans-serif,Arial; overflow:hidden; white-space:nowrap; }",
			...
			*/
			...
			{
				// google font
				var fontRef = ('https:' == document.location.protocol ? 'https' : 'http') + "://fonts.googleapis.com/css?family=Montserrat:300";
				...
				inst.$lightbox = jQuery("<div id='html5-lightbox' style='display:none;position:absolute;top:0px;left:0px;width:100%;height:100%;z-index:999;'>" +
						...
						"<div id='html5-lightbox-box' style='display:block;position:relative;margin:0px auto;overflow:hidden;'>" +
							"<div id='html5-elem-box' style='display:block;position:relative;margin:0px auto;text-align:center;'>" +
								...
								"</div>" + 
								"<div id='html5-next' style='display:none;cursor:pointer;position:absolute;right:" + inst.options.bordersize + "px;top:80%;'><img src='" + inst.options.skinfolder + "next.png'></div>" +
//								"<div id='html5-prev' style='display:none;cursor:pointer;position:absolute;left:" + inst.options.bordersize + "px;top:40%;'><img src='" + inst.options.skinfolder + "prev.png'></div>" +							
							...
							"<div id='html5-elem-data-box' style='display:none;position:relative;width:100%;margin:0px auto;height:" + inst.options.barheight + "px;background-color:" + inst.options.bgcolor + ";'>" +
								"<div id='html5-text' style='display:block;float:left;overflow:hidden;width:85%;border:0px #fff solid;margin-left:" + inst.options.bordersize + "px;'></div>" +
//new wrapper								"<div style='display:block;float:right;border:1px solid;'>" +
//									"<div id='html5-prev' style='display:inline;cursor:pointer;margin-right:10px;'><img src='" + inst.options.skinfolder + "prev-w32.png'></div>" +
//									"<div id='html5-next' style='display:inline;cursor:pointer;margin-right:10px;'><img src='" + inst.options.skinfolder + "next-w32.png'></div>" +
//									"<div id='html5-close' style='display:inline;cursor:pointer;margin-right:" + inst.options.bordersize + "px;'><img src='" + inst.options.skinfolder + "close.png'></div>" +
//new wrapper								"</div>" +
...
//							"<div id='html5-watermark' style='display:none;position:absolute;left:" + String(inst.options.bordersize + 2) + "px;top:" + String(inst.options.bordersize + 2) + "px;'></div>" + 
				...
				{
					inst.$watermark.html("<a href='" + inst.options.freelink + "' style='text-decoration:none;'><div style='display:block;width:120px;height:20px;text-align:center;border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;filter:alpha(opacity=60);opacity:0.6;background-color:#333333;color:#1a1a1a;font:12px Armata,sans-serif,Arial;'><div style='line-height:20px;'>" + inst.options.freemark + "</div></div></a>");
				}
			...
			*/
			inst.showImage = function(elem, imgW, imgH)
			{
				...
				inst.resizeLightbox(sizeObj.w, sizeObj.h, true, function(){
					...
					// show image	
//stop it from sizing the caption box
			...
			*/
			...
			inst.showYoutubeVimeo = function(elem)
			{
				...
				inst.resizeLightbox(dataW, dataH, true, function(){
					...
					inst.$text.css({width: inst.calcTextWidth(dataW)});
					inst.$text.html(elem[ELEM_TITLE]);
					inst.$image.html("<div id='html5lightbox-video' style='background-color:000;display:block;width:" + dataW + "px;height:" + dataH + "px;'></div>").show();
...
//added by me: fade em up at start
//									inst.$next.fadeIn();
//									inst.$prev.fadeIn();
			...
			*/
			...
			inst.embedFlash = function($container, w, h, src, wmode, flashVars)
			{
				...
				{
					var htmlOptions = {
							plugins	: "http://www.adobe.com/go/getflashplayer",
							quality: "high",
